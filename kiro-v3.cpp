// In IDLE Mode:
// 🔄 Rotate Encoder: Adjust weight (0.1g increments)
// 👆 Single Press: Cycle Presets (much easier!)
// 👆👆 Double Press: Start Dosing
// 👆⏱️ Long Press: Enter Menu
// 🔄+👆 Rotate + Hold: Purge Mode
...
void handleShortPress() {
  ...
  switch (doseState) {
    case IDLE:
      // Single press = Cycle presets (easier than double press)
      cyclePresets();
      break;
    case MENU:
      handleMenuSelect();
